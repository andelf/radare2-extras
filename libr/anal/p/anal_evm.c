...
static unsigned opcodes_types[] = {
	...
	[EVM_OP_SHL] = R_ANAL_OP_TYPE_SHL,
	[EVM_OP_SHR] = R_ANAL_OP_TYPE_SHR,
	[EVM_OP_SAR] = R_ANAL_OP_TYPE_SAR,
	...
	[EVM_OP_CALLTOKEN] = R_ANAL_OP_TYPE_CRYPTO,
	[EVM_OP_TOKENBALANCE] = R_ANAL_OP_TYPE_CRYPTO,
	[EVM_OP_CALLTOKENVALUE] = R_ANAL_OP_TYPE_CRYPTO,
	[EVM_OP_CALLTOKENID] = R_ANAL_OP_TYPE_CRYPTO,
	[EVM_OP_ISCONTRACT] = R_ANAL_OP_TYPE_CRYPTO,
